              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex items-center gap-1 bg-emerald-500 text-white hover:bg-emerald-600"
                  >
                  ...
                  <Button
                    ...
                    className="flex items-center gap-1 bg-rose-500 text-white hover:bg-rose-600"
                  >
        ...
        <CardContent>
          {filteredStaffs.length === 0 ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold mb-2">No staffs found</h3>
              ...
              {!searchTerm && (
                <Button onClick={() => router.push(`/${role}/staffs/create`)}>
